...
exports.verificacionDeFecha = void 0;
var _Persona = _interopRequireDefault(require("../models/Persona.js"));
var _configMail = require("../nodemailer/configMail.js");
...
var verificacionDeFecha = exports.verificacionDeFecha = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var fecha, mesActual, personas, listaCumpleañios, listaFinalContrato;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 5:
          ...
          listaCumpleañios = personas.filter(function (empleado) {
            var mes = new Date(empleado.fecha_nacimiento).getMonth() + 1;
            return mes === mesActual;
          });
          listaFinalContrato = personas.filter(function (empleado) {
            var mes = new Date(empleado.fecha_final_contrato).getMonth() + 1;
            return mes === mesActual;
          });
  ...
  return function verificacionDeFecha() {
