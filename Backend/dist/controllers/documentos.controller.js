...
exports.putDocumento = exports.getAllDocumento = exports.deleteDocumento = exports.createDocumento = void 0;
var _Documento = _interopRequireDefault(require("../models/Documento.js"));
...
var createDocumento = exports.createDocumento = /*#__PURE__*/function () {
  ...
  return function createDocumento(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var getAllDocumento = exports.getAllDocumento = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$query, cerificado_N, tipo, query, documento;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _req$query = req.query, cerificado_N = _req$query.cerificado_N, tipo = _req$query.tipo;
          query = {};
  ...
  return function getAllDocumento(_x3, _x4) {
...
var putDocumento = exports.putDocumento = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 7:
          _context3.next = 9;
          return _Documento["default"].findByIdAndUpdate(req.params.id, {
            cerificado_N: cerificado_N,
            tipo: tipo,
            fecha_expedicion: fecha_expedicion,
            fecha_vencimiento: fecha_vencimiento,
  ...
  return function putDocumento(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
var deleteDocumento = exports.deleteDocumento = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _context4.next = 3;
          return _Documento["default"].findByIdAndDelete(req.params.id);
        case 3:
          documento = _context4.sent;
          if (documento) {
            _context4.next = 6;
            break;
          }
  ...
  return function deleteDocumento(_x7, _x8) {
