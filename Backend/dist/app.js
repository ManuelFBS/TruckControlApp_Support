...
import csrfMiddleware, { generateCsrfToken, verifyCsrfToken, handleCsrfError } from './middlewares/csrfMiddleware.js';
...
app.use('/api/cargapesada', verifyCsrfToken,
// CON PROTECCION CSRF...
cargaPesadaRoutes);
...
// Test route...
app.get('/', (req, res) => {
  res.end(`Welcome to Backend Node.js Server. Running on port: ${app.get('port')}...!`);
});
export default app;