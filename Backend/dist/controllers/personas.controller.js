...
exports.updatePersona = exports.getPersonaByID = exports.getPersonaByDNI = exports.getAllPersonas = exports.deletePersona = exports.createPersona = void 0;
...
var createPersona = exports.createPersona = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, cedula, nombres, apellidos, fecha_nacimiento, correo, telefono, fecha_inicio_contrato, fecha_final_contrato, tipo_de_contrato, newPersona, savedPersona;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _req$body = req.body, cedula = _req$body.cedula, nombres = _req$body.nombres, apellidos = _req$body.apellidos, fecha_nacimiento = _req$body.fecha_nacimiento, correo = _req$body.correo, telefono = _req$body.telefono, fecha_inicio_contrato = _req$body.fecha_inicio_contrato, fecha_final_contrato = _req$body.fecha_final_contrato, tipo_de_contrato = _req$body.tipo_de_contrato;
          _context.prev = 1;
          newPersona = new _Persona["default"]({
            cedula: cedula,
            nombres: nombres,
            apellidos: apellidos,
  ...
  return function createPersona(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var getAllPersonas = exports.getAllPersonas = /*#__PURE__*/function () {
  ...
  return function getAllPersonas(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
var getPersonaByDNI = exports.getPersonaByDNI = /*#__PURE__*/function () {
  ...
  return function getPersonaByDNI(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
var getPersonaByID = exports.getPersonaByID = /*#__PURE__*/function () {
  ...
  return function getPersonaByID(_x7, _x8) {
