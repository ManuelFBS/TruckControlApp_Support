...
exports.updateVehiculo = exports.getVehiculoById = exports.getAllVehiculos = exports.deleteVehiculo = exports.createVehiculo = void 0;
...
var createVehiculo = exports.createVehiculo = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, placa, tipo_de_combustible, clase_de_vehiculo, marca, color, propietario, documentos, volquetas, tanqueos, vehiculo;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _req$body = req.body, placa = _req$body.placa, tipo_de_combustible = _req$body.tipo_de_combustible, clase_de_vehiculo = _req$body.clase_de_vehiculo, marca = _req$body.marca, color = _req$body.color, propietario = _req$body.propietario, documentos = _req$body.documentos, volquetas = _req$body.volquetas, tanqueos = _req$body.tanqueos;
...
var updateVehiculo = exports.updateVehiculo = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var id, _req$body2, placa, tipo_de_combustible, clase_de_vehiculo, marca, color, propietario, documentos, volquetas, tanqueos, updates, vehiculo;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          id = req.params.id;
          _req$body2 = req.body, placa = _req$body2.placa, tipo_de_combustible = _req$body2.tipo_de_combustible, clase_de_vehiculo = _req$body2.clase_de_vehiculo, marca = _req$body2.marca, color = _req$body2.color, propietario = _req$body2.propietario, documentos = _req$body2.documentos, volquetas = _req$body2.volquetas, tanqueos = _req$body2.tanqueos;
          updates = {
            placa: placa,
            tipo_de_combustible: tipo_de_combustible,
            clase_de_vehiculo: clase_de_vehiculo,
          ...
          _context4.prev = 4;
          _context4.next = 7;
          return _Vehiculo["default"].findByIdAndUpdate(id, updates, {
            "new": true,
            runValidators: true
          });
        case 7:
  ...
  return function updateVehiculo(_x7, _x8) {
...
var deleteVehiculo = exports.deleteVehiculo = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.prev = 1;
          _context5.next = 4;
          return _Vehiculo["default"].findByIdAndDelete(id);
        case 4:
  ...
  return function deleteVehiculo(_x9, _x10) {
